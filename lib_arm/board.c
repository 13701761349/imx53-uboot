...
//	udelay(1000*1000*10);
	...
	unsigned long addr;
              ...
              // add by panzidong
extern  void  PULL_3v3_en_pull_up();
             // end by panzidong
              PULL_3v3_en_pull_up();

               // add by panzidong
extern  void  power_left_led();
             // end by panzidong
              power_left_led();
 	     // add by panzidong
extern void dc_plug_out();
	    dc_plug_out();
	     // add by panzidong
       

	//add by zed
	extern  void  imx53_33v_on();
	imx53_33v_on();
	extern  void  imx53_5v_on();
	imx53_5v_on();
	extern  void  imx53_lcd_config();
	imx53_lcd_config();
...
//change by ljs for update
	...
	eth_initialize(gd->bd);
        ...
        // add by panzidong
extern  void autoset_mac_addr(void);
        // end by panzidong
         autoset_mac_addr();
